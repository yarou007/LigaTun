        ...
        ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="../../index.php?action=updateResAd&idRes=<?php echo $res->idRes ?>" class="btn btn-success btn-sm">Modifier</a>
                             <a href="../../index.php?action=deleteResAd&idRes=<?php  echo $res->idRes ?>" class="btn btn-warning btn-sm">Supprimer</a> 
...
<?php require_once('AccueilCS.php'); ?>