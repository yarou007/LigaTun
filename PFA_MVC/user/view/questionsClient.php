    ...
    <div class="row" style="margin-left: 10%; ">
        <div class="col-lg-12 col-sm-12 my-4 text-center">
            <div class="histo_reserv_box">
                <p> Vous avez de questions? </p>
            </div>
        </div>
    </div>
    <form method="post" action="../index.php?action=reclamation" class="row g-3" style="margin-left: 18%; ">
        ...
        <div class="col-lg-10 mb-3">
            ...
            <textarea class="form-control" name="question" id="exampleFormControlTextarea1" rows="3" placeholder="Nsab7ou aala khatrek"></textarea>
        </div>
